...
use Magento\Framework\Mail\Template\TransportBuilder as TransportBaseBuilder;
...
class TransportBuilder
{
  ...
  public function addAttachment(
    $content,
    $fileName    = null,
    $fileType    = MimeInterface::TYPE_OCTET_STREAM,
    ...
    $attachmentPart = $this->mimePartInterfaceFactory->create([
      ...
      'type' => $fileType,
      'fileName' => $fileName,
      'disposition' => isset($disposition) ? $disposition : MimeInterface::DISPOSITION_ATTACHMENT,
      'encoding' => isset($encoding) ? $encoding : MimeInterface::ENCODING_BASE64
    ]);
